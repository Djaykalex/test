...
<div class="section">
	<div class="box">
		<div class="title">
			...
			<a class="btn black" href="<?php echo BASE_URL; ?>/articles_types/backoffice_add" style="float: right; margin-right:150px; margin-top: -33px; "><span>Ajouter</span></a>
		</div>
		<div class="content">					
			<table cellspacing="0"  class="table" cellpadding="0" border="0">
				...
				<style>
					...
					<tr> 
						...
						<td>
							<a href="<?php echo BASE_URL; ?>/articles_types/backoffice_edit/<?php echo $v['id']; ?>"><img src="<?php echo BASE_URL; ?>/img/backoffice/thumb-edit.png" alt="edit" /></a>
						</td>
						<td>
							<a href="<?php echo BASE_URL; ?>/articles_types/backoffice_delete/<?php echo $v['id']; ?>" class="deleteBox" onclick="return confirm('Voulez vous vraiment supprimer?');"><img src="<?php echo BASE_URL; ?>/img/backoffice/thumb-delete.png" alt="delete" /></a>
						</td>
