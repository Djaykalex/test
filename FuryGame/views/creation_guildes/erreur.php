<div class="grid_16 background_blanc">
	<div class="grid_3 icone_article">
		<img class="tournoi_soustitre_icone" src="<?php echo BASE_URL;?>/img/icones/1358879576_fileclose.png" title="Festival Fury-Game" alt="Festival Fury-Game" />
	</div>
	<div class="grid_13 principe_tournoi" style=" width:700px; margin-right:20px">
		<div class="titre_articles">Erreur, vous avez déjà créé une guilde</div>
