...
/**
* La fonction backoffice_index va permettre d'afficher en detail les articles dans la page d'accueil du backoffice...
...
/**
* La fonction backoffice_add va permettre d'ajouter un article dans la page d'accueil du backoffice...
* @param 	$id 		INT 		c'est l'identifiant de l'article
* @param 	$table 		varchar  	variable qui contient le nom de la table
* @param 	$link 		varchar  	c'est le connecteur
* @param 	$_POST	 	mixed 		Données posté
...
/**
* La fonction backoffice_edit va permettre d'editer un article dans la page d'accueil du backoffice...
* @param 	$id 		INT 		c'est l'identifiant de l'article
* @param 	$table 		varchar  	variable qui contient le nom de la table
* @param 	$link 		varchar  	c'est le connecteur
* @param 	$_POST	 	mixed 		Données posté
